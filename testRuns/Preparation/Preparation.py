def makeOAR( EXEC_DIR, node, core, time, PYFIL ):
	...
	print >> someFile, "$EXEC_DIR/lmp_serial < in.txt -var OUT_PATH %s pair_coeff_args $MEAM_library_DIR/library_CoNiCrFeMn.meam Co Ni Cr Fe Mn $MEAM_library_DIR/parameters.meam Co Ni Cr Fe Mn" %( PYFIL, OUT_PATH )
	someFile.close()										  
