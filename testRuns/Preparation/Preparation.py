...
if __name__ == '__main__':
	...
	#
	jobname  = {
				1:'CuZrNatom32KT300Tdot1E-2Sheared',
			   }[1]
	...
	#
	Variable = {
				0:' -var natoms 32000 -var cutoff 3.52 -var tstart 300.0 -var tstop 2000.0 -var TdotMelt 100.0 -var TdotQuench 0.01 -var Pinit 1.0132 -var nevery 1000 -var ParseData 0  -var DumpFile dumpInit.xyz -var WriteData data_init.txt',
