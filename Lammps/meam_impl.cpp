...
MEAM::~MEAM()
{
  ...
  memory->destroy(this->dG_array);
  memory->destroy(this->ddG_array);
  memory->destroy(this->dGbar_array);
  memory->destroy(this->ddGbar_array);
  memory->destroy(this->rho_bkgd_array);
