...
MEAM::Get_ddrho3drmdrn( int i,
        ...
        double a3 = 6.0* rhoa3j / rij3;//6.0* rhoa3j* sij / rij3;
        double a3a = 6.0 * rhoa3j / (5 * rij);//6.0 * rhoa3j* sij / (5 * rij);
         double a3b = rhoa3j / rij3;//rhoa3j * sij / rij3;
         double a3c = rhoa3j / rij;//rhoa3j*sij / rij;
