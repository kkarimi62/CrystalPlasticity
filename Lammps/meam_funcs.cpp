...
//   }
      ...
      if(i==0 and j==1 and alpha==0 and beta==1){
         ...
         fprintf( pFile,"%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\t%e\n",rik,rjk,rij,sij,delij[0],delij[1],delij[2],dsg_alpha_beta_drm[0],dsg_alpha_beta_drm[1],dsg_alpha_beta_drm[2],dsg_alpha_beta_dr,dsg_alpha_beta_ds,dsg_alpha_beta_drik,dsg_alpha_beta_drjk);
         fclose(pFile);
      }
