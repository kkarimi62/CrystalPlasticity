...
//        ddrho2drdr2 = Get_ddrho2drdr( j, rij,  sij, rhoa2i,  drhoa2i,  ddrhoa2i, arho2b, arg1j2, arg1j2_d );
	...
	da2 = -2*a2/rij;
        for (m = 0; m < 3; m++) {
  	    ...
  	    ddrho2drmdr1[m]+= darho2[i][this->vind2D[m][n]] * delij[n];
  	    ddrho2drmdr2[m]+= -darho2[j][this->vind2D[m][n]] * delij[n];
          }
