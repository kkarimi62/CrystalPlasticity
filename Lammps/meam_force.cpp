...
//          dUdrijm[m] = 0.0;//drho0drm1[m] + drho0drm2[m]; //--- Eq. 4.41(c)
...
//          ddUdrdrijm[m] = 0.0;//ddrho0drmdr1[m] + ddrho0drmdr2[m];
          for (n = m; n < 3; n++) {
...
//          stiff *= rij2; //--- *r^2 to get energy
          vm[ 0 ]  = -0.5*GetModulus( 
                         i, j, x, numneigh, firstneigh, numneigh_full, firstneigh_full, type, fmap,
