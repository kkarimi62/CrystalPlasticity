...
//
        ...
        a1 = 2 * sij / rij;
        da1 = -a1/rij;
        drho1dr1 = 0.0;//a1 * (drhoa1j - rhoa1j / rij) * arg1i1; //--- 4.30(a)
        drho1dr2 = 0.0;//a1 * (drhoa1i - rhoa1i / rij) * arg1j1;
        ddrho1drdr1 = 0.0;//da1 * (drhoa1j - rhoa1j / rij) * arg1i1 + 
...
//              fprintf (pFile, "%e %e %e %e %e\n",rij, sij, arg1i1, arg1i1, arg1i1_d);
       ddrho1drdr2 = 0.0;//da1 * (drhoa1i - rhoa1i / rij) * arg1j1 + 
        ...
        da1 = -a1/rij;
        for (m = 0; m < 3; m++) {
          drho1drm1[m] = 2*delij[m];//a1 * rhoa1j * arho1[i][m]; //--- 4.30(c)
          drho1drm2[m] = 2*delij[m];//a1 * rhoa1i * arho1[j][m]; //--- d/drij[m]=-d/drji[m]
        ...
        for (m = 0; m < 3; m++) {
         for (n = m; n < 3; n++) {
          ddrho1drmdrn1[ nv2 ] = 2*(m==n?1:0);//a1 * rhoa1j * darho1drni[nv2];
          ddrho1drmdrn2[ nv2 ] = 2*(m==n?1:0);//a1 * rhoa1i * darho1drnj[nv2];
          nv2++;
         }
        }
