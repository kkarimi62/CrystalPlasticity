...
//
        ...
        a1 = 2 * sij / rij;
        da1 = -a1/rij;
        drho1dr1 = 2*rij;//a1 * (drhoa1j - rhoa1j / rij) * arg1i1; //--- 4.30(a)
        drho1dr2 = 2*rij;//a1 * (drhoa1i - rhoa1i / rij) * arg1j1;
        ddrho1drdr1 = 2.0;//da1 * (drhoa1j - rhoa1j / rij) * arg1i1 + 
...
//              fprintf (pFile, "%e %e %e %e %e\n",rij, sij, arg1i1, arg1i1, arg1i1_d);
       ddrho1drdr2 = 2.0;//da1 * (drhoa1i - rhoa1i / rij) * arg1j1 + 
