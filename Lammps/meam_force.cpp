...
//             fprintf (pFile, "%e %e %e\n",delij[0], drhods1,ddrhodrmds1[0]);
	...
	if(i==0 and j == 1)
		...
		sij, rho3[i], drho3dr1, drho3ds1, drho3drm1[0], drho3drm1[1], drho3drm1[2], 
				ddrho3drds1, ddrho3dsds1, ddrho3drmds1[0], ddrho3drmds1[1], ddrho3drmds1[2] );
